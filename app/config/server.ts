...
declare global {
  namespace NodeJS {
    interface ProcessEnv {
      ...
      // iflytek only
      IFLYTEK_URL?:'这里写接口地址 Write the API endpoint here' ;
      IFLYTEK_API_KEY?: '这里写API KEY Write the API KEY here';
      IFLYTEK_API_SECRET?:'这里写API SECRET Write the API SECRET here';
